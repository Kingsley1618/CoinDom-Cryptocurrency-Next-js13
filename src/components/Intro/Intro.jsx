...
<img src = "/bitcoinFloat.png" alt="btc-image" className="md:flex hidden w-[70px] h-[70px] animate-bounce" />

<div className="text-white md:text-[70px] lg:text-[80px] md:text-[60px] text-[50px] text-[50px] text-center font-bold"style = {{flex:"1"}} >
TRACK AND TRADE
</div>
<img src = "EthFloat.png" alt="btc-image" className="md:flex hidden  w-[70px]  h-[70px] animate-bounce" />
</div>
...
{data.map((coin)=> {
    return <div className="flex flex-col items-center gap-y-2">
        <img src ={coin.image} className="w-[80px] h-[80px]" alt="coin-img"/>
